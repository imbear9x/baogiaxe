...
$meta_boxes = array(
	  ...
	  "description" => __('New, Used, Sale, Sold, Reduced or Custom tag','language'),
...
"featured" => array(
	  ...
	  "description" => __('Show listing on home page slideshow.','language'),
...
"topdeal" => array(
	  ...
	  "description" => __('If yes this vehicle will show on the Top Deals widget.','language'),
...
"CityMPG" => array(
	  ...
	  "description" =>  __('Enter City MPG.','language'),
...
"HighwayMPG" => array(
	  ...
	  "description" =>  __('Enter Highway MPG.','language'),
...
add_meta_box( 'gallery', __('Photo Gallery (drag thumbnails to order photos in gallery)','language'), 'show','gtcd', 'normal', 'high' );
