( function( $ ) {
	...
	wp.customize( 'widgets_background_color', function( value ) {
		value.bind( function( newval ) {
			$('.arrivals-details,.welcome_widget').css('background-color', newval );
		} );
	} );
	...
	wp.customize( 'box_shadow', function( value ) {
		value.bind( function( newval ) {
			$('.find-wrapper,nav#menu,.side-widget,.welcome_widget,.tricol-product-list .item-container,.result-car,.overview,.footer-container,.blog-post').css( 'box-shadow','0px 1px 8px '+ newval );		
		} );
	} );
	...
	wp.customize( 'menu_background_active', function( value ) {
		value.bind( function( newval ) {
			$('nav#menu .active a,.navbar-nav .inventory .active a,nav#menu a:hover,.top-bar').css('background-color ', newval);
		} );
	} );
	...
	wp.customize( 'buttons_background_color', function( value ) {
		value.bind( function( newval ) {
			$('.detail-btn').css('background', newval);
		} );
	} );
	...
	wp.customize( 'widgets_background_color', function( value ) {
		value.bind( function( newval ) {
			$('.arrivals-details,.footer-container').css('background', newval );
		} );
	} );
	...
	wp.customize( 'menu_background', function( value ) {
		value.bind( function( newval ) {
			$('nav#menu').css('background-color', newval );
		} );
	} );
	wp.customize( 'menu_background', function( value ) {
		value.bind( function( newval ) {
