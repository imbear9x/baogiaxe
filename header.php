...
<body <?php body_class(); ?>>
<div class="top-bar hidden-xs hidden-sm hidden-md"><div class="container-fluid"><div class="title-tag"><?php $description = get_bloginfo( 'description', 'display' );
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 center-block">
					<?php if (get_header_image() == '') { ?><div class="col-sm-3 hidden-xs" id="logo">
					<?php if ( function_exists( 'the_custom_logo' ) ) { the_custom_logo(); } ?> 
						</div>
					<div class="col-sm-9 hidden-xs" id="phone">
					<img src="http://giaxeford24h.com/wp-content/uploads/2019/03/17_focus_electric-banner.png" alt="Gia xe ford banner" class="img-responsive"/>
				</div>
