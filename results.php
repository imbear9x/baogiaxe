	...
	$args = array(
		...
		if ($attachments) {
			foreach ($attachments as $attachment) {
				echo '<div class="col-sm-5 col-results">'.wp_get_attachment_image($attachment->ID, 'large',false,array('class' =>'img-responsive'));?><div class="status-tag <?php echo $fields['statustag'];?>"><?php echo $fields['statustag'];?></div></div><?php 
				}
			} ?>
<?php
