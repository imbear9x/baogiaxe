...
<div class="col-sm-4 result-detail-wrapper col-results"> 
  ...
  <p class="miles-style"><?php if ( $fields['miles']){ echo number_format($fields['miles']).' '.$options['miles_text'];} elseif ($fields['miles'] == '0' ){ echo _e('0','language').' '.$options['miles_text'];} else {echo '';}  ?></p><p class="car-info"><?php if (isset( $fields['transmission'])){ echo $fields['transmission'];}else {  echo ''; };?>
